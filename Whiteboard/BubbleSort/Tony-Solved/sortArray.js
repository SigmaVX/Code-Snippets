...
sortThisArray = (event) => {
  ...
  document.getElementById("tony").innerHTML = sortedArray.join(" ");
}
...
// Event Listeners
document.getElementById("go").addEventListener("click", sortThisArray);
document.getElementById("go").addEventListener("click", sortArrayLong);