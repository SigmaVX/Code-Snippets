      ...
      <BrowserRouter>
        <div className="App">          
          <header className="Nav">
            ...
            <ul>
                <li>
                  <NavLink to="/" activeStyle={{color: "red", fontSize: "20px"}}>Home</NavLink>
                </li>
                <li>
                  <NavLink to="/courses" activeStyle={{color: "red", fontSize: "20px"}}>Courses</NavLink>
                </li>
                <li>
                  <NavLink to="/users" activeStyle={{color: "red", fontSize: "20px"}}>Users</NavLink>
                </li>
              </ul>
            </nav>
          </header>
